-- Create boat_products table
CREATE TABLE IF NOT EXISTS boat_products (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    product_name TEXT NOT NULL,
    brand TEXT DEFAULT 'boAt',
    product_id TEXT,
    category TEXT,
...
CREATE INDEX IF NOT EXISTS idx_boat_product_name ON boat_products(product_name);
CREATE INDEX IF NOT EXISTS idx_boat_category ON boat_products(category);
CREATE INDEX IF NOT EXISTS idx_boat_price ON boat_products(price_inr);
