...
export default function DIQModal({ onClose }: DIQModalProps) {
    ...
    const [results, setResults] = useState<DIQProduct[] | null>(null);
    ...
    const getMatchReason = (product: DIQProduct) => {
        ...
        if ((product.battery_hours ?? 0) > 40) return "Exceptional battery life for long usage";
