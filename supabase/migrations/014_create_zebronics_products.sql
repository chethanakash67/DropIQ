-- Create zebronics_products table
CREATE TABLE IF NOT EXISTS zebronics_products (
...
CREATE INDEX IF NOT EXISTS idx_zebronics_product_name ON zebronics_products(product_name);
CREATE INDEX IF NOT EXISTS idx_zebronics_category ON zebronics_products(category);
CREATE INDEX IF NOT EXISTS idx_zebronics_price ON zebronics_products(price_inr);
