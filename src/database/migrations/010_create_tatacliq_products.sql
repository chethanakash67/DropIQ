-- Create tatacliq_products table
CREATE TABLE IF NOT EXISTS tatacliq_products (
...
CREATE INDEX IF NOT EXISTS idx_tatacliq_product_name ON tatacliq_products(product_name);
CREATE INDEX IF NOT EXISTS idx_tatacliq_category ON tatacliq_products(category);
