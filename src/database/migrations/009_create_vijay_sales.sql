-- Create vijay_sales_products table
CREATE TABLE IF NOT EXISTS vijay_sales_products (
...
CREATE INDEX IF NOT EXISTS idx_vijay_sales_product_name ON vijay_sales_products(product_name);
CREATE INDEX IF NOT EXISTS idx_vijay_sales_category ON vijay_sales_products(category);
